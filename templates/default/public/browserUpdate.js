...
var $bu_ = new (function () {
	...
	this.get_browser = function (ua) {
		...
		if (
			/windows.nt.5|windows.nt.4|windows.nt.6.0|windows.95|windows.98|os x 10.2|os x 10.3|os x 10.4|os x 10.5/i.test(
				ua
			)
		) {
...
var $buo = function (op, test) {
	...
	op.domain =
		op.domain !== undefined ? op.domain : (/file:/.test(location.href) ? 'https:' : '') + '//browser-update.org';
