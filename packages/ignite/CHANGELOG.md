...
- e18453c: fix(ignite): used tanstack router hook insted of use mach hook since use mach was not reactive
...
- e53f7fc: fix(ignite): correctly check for back-btn availability
